    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <div className="mb-4">
            <label className="block text-sm font-bold text-gray-700 mb-2 text-left">Full Name</label>
          ...
          <div className="mb-6">
            <label className="block text-sm font-bold text-gray-700 mb-2 text-left">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
              <input
                type="password"
